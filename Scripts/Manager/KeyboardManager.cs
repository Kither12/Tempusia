...
public class KeyboardManager : MonoBehaviour
{
    ...
    public static void DoRebind(string actionName, int bindingIndex, List<KeyboardRebind> otherKeys)
    {
    ...
    public static void RemoveDuplicate(string actionName, int bindingIndex, List<KeyboardRebind> otherKeys)
    {
